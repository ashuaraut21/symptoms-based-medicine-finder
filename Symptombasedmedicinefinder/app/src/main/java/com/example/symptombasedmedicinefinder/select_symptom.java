...
public class select_symptom extends AppCompatActivity {
    ListView listView;
    Button getChoice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getChoice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(select_symptom.this, selected, Toast.LENGTH_LONG).show();
                Intent i1=new Intent(select_symptom.this,disease_prediction.class);
        ...
        try {
            ...
            Toast.makeText(select_symptom.this,""+e,Toast.LENGTH_LONG).show();
        }
    }
